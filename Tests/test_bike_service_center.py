...
@pytest.mark.smoke
def bike_service(browserInstance):
    browserInstance.get("https://www.carandbike.com/")
    browserInstance.maximize_window()
    safe_click(browserInstance, Locators.NEW_BIKES)
    safe_click(browserInstance,Locators.Service_Centers)
    details = safe_get_text(browserInstance, Locators.service_center_details)
    print(f"Key_highlights: {details}")